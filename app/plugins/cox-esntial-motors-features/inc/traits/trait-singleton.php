...
namespace Cox_Esntial_Motors\Features\Inc\Traits;
...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( $instance[ $called_class ] ) ) {
			...
			/**
			 * Dependent items can use the cox_esntial_motors_features_singleton_init_{$called_class} hook to execute code
			 */
			do_action( sprintf( 'cox_esntial_motors_features_singleton_init_%s', $called_class ) ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
